      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-20">
          ...
          >
            ...
            >
              Tell us about your spa and we will reach out within 24 hours to
              discuss how ZenFlow can protect your revenue and free up your
              front desk.
            </motion.p>
              ...
              >
                <div className="grid gap-5 sm:grid-cols-2">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      type="email"
                      required
                      placeholder="jane@spabusiness.com"
                      className="h-11 rounded-lg bg-background border-border font-body text-sm placeholder:text-muted-foreground/50"
                    />
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    ...
                    required
                    rows={4}
                    placeholder="Tell us about your spa and what you are looking for..."
