...
const SERVICES = [
  {
    ...
    description:
      "A natural-sounding AI voice agent that answers every phone call your spa receives. It speaks with callers, answers questions about your services and availability, and books appointments directly into your calendar. No more missed calls, no more lost revenue, and no more frantic front-desk scrambling during peak hours.",
    features: [
      "Natural, human-like voice conversations",
      "Direct calendar booking (Vagaro, Mindbody, Square)",
  ...
  },
  {
    ...
    features: [
      ...
      "Software integration with your existing tools",
    ],
    icon: MessageSquare,
    accent: false,
  },
  {
    ...
    description:
      "Custom automated workflows that connect your AI receptionist to the rest of your business operations. From no-show prevention sequences and automated review generation to multi-step follow-up campaigns, we build the systems that keep your spa running smoothly without manual effort.",
    features: [
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            ...
            communication, protect your revenue, and free your front desk.
          </motion.p>
        </motion.div>
